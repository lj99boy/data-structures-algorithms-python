from other.dispersed_event_simulation.simulation import Simulation
from other.dispersed_event_simulation.simulation import SQueue
from other.dispersed_event_simulation.event import Event
...
car_check_time = (4,6)
cus = Customs(3,10,car_arrive_interval,car_check_time)
cus.simulate()